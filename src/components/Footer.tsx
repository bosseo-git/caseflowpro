...
const navigation = {
  ...
  social: [
    {
      name: 'Twitter',
      href: 'https://twitter.com/caseflowpro',
    ...
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/company/caseflowpro',
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/caseflowpro',
      icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
      ...
      <div className="container px-4 py-12 mx-auto">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              {navigation.product.map((item) => (
                <li key={item.name}>
                  <Link href={item.href} className="text-base text-gray-600 hover:text-primary-600">
                    {item.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="flex mt-4 space-x-6">
              {navigation.social.map((item) => (
                <a key={item.name} href={item.href} className="text-gray-500 hover:text-primary-600">
        ...
        <div className="pt-8 mt-8 border-t border-gray-200">
          <p className="text-base text-gray-500">
            &copy; {new Date().getFullYear()} CaseFlowPro. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
